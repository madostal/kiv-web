...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `username_uzivatele` (`iduzivatel`, `jmeno`, `login`, `heslo`, `email`, `idprava`) VALUES (1, 'Pokusný administrátor', 'admin', 'admin', 'pokus1@kiv.zcu.cz', 1);
INSERT INTO `username_uzivatele` (`iduzivatel`, `jmeno`, `login`, `heslo`, `email`, `idprava`) VALUES (2, 'Pokusný recenzent', 'pokus', 'pokus', 'pokus2@kiv.zcu.cz', 2);

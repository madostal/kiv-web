...
// POZOR:
// - synchronizace casu v PHP s casem v databazi.
// - nejjednossi varianta
// - obvykle byva resena opravdova synchronizace casu
//   protoze klient ma casovou zonu jinou nez server.
...
if($serverName == "localhost" || $serverName == "10.0.2.2"){
    ...
    // PRODUKCE - pro server
    // TODO - spravnou konfiguraci dle serveru !!
    $url = "vlastni_url_adresa";
    $dbSettings = [
        'host' => 'localhost',
        'username' => '',
